...
const LoginPage = () => {
    ...
    return (
        /* Outer Canvas strictly locked to deep dark background */
        <div className="min-h-screen flex bg-[#07090e] text-white transition-colors duration-300 relative overflow-hidden">
            ...
            {/* Left panel - Hero & Visuals (Always Dark) */}
            <div className="hidden lg:flex flex-col justify-between w-7/12 p-12 relative z-10">
                ...
                {/* Animation graphic */}
                <div className="flex-1 flex items-center justify-center relative my-8 scale-125 xl:scale-150">
                    <WorkflowAnimation />
                </div>
            ...
            {/* Right panel - Floating Glass Card (Adapts nicely to dark/light toggle) */}
                ...
                <div className="w-full max-w-md p-8 sm:p-10 rounded-3xl dark:bg-[#111622]/90 bg-white/95 backdrop-blur-xl shadow-2xl dark:shadow-black/60 border dark:border-white/10 border-gray-200 transition-all">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-sm dark:text-gray-400 text-gray-500 mt-1">
                            Sign in to continue managing your workflows.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2">
                                <label className="block text-xs font-semibold uppercase tracking-wider dark:text-gray-300 text-gray-600">
                                    Password
                                </label>
                            </div>
                            <div className="relative">
